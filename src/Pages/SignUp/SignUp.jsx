  ...
  const handleGoogle = () => {
    googleSignIn()
      .then((result) => {
        ...
        axios.post(`https://server-site-beta.vercel.app/register`, userInfo).then((res) => {
          console.log(res);
          ...
          <div className="lg:w-3/5 md:p-8 p-2">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="mt-4 gap-10">
                <button onClick={handleGoogle} type="submit" className="btn bg-[#0360D9] hover:bg-[#0360D9] text-white w-full">
